...
static class Util
{
    ...
    public static Point Point(PointF pf) => new((int)pf.X, (int)pf.Y);
    ...
    public static void Draw2ColorBar(Graphics dc, RectangleF r, Orientation orientation, Color c1, Color c2)
    {
        ...
        {
            LinearGradientBrush lb1 = new(lr1, c1, c2, angle, false);
    ...
    public static void Draw3ColorBar(Graphics dc, RectangleF r, Orientation orientation, Color c1, Color c2, Color c3)
    {
        ...
        if (lr1.Height > 0 && lr1.Width > 0)
        {
            LinearGradientBrush lb2 = new(lr2, c1, c2, angle, false);
            LinearGradientBrush lb1 = new(lr1, c2, c3, angle, false);
    ...
    public static List<Control> controlsSorted(this Control panel) {
        List<Control> controls = panel.Controls.OfType<Control>().ToList();
...
public class Hook
{
    ...
    public void SetHook(bool enable)
    {
        if (enable && m_hHook == 0)
        {
            m_HookCallback = HookCallbackProc;
